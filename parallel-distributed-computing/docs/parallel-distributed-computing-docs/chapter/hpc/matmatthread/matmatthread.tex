\begin{chapter}{MatMatThread}
    \begin{section}{Problem at a glance}
        \par Given matrices $A$, $B$, $C$, $blockN1$, $blockN2$, $blockN3$, a number of $NTROW \times NTCOL$ threads, the goal is to compute the \glsxtrshort{gemm} operation $C = C + AB$ in a multithreaded MatMatBlock algorithm.
    \end{section}
