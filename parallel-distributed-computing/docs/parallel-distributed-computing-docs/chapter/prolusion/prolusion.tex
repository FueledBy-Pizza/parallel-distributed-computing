\begin{chapter}{Prolusion}
	\begin{section}{Goal}
		\par A comprehensive overview of a \glsxtrlong{pdc} project developed in \texttt{C} is presented. The project consists of multiple modules delivered in incremental phases. Every algorithm is implemented within the \textbf{\glsxtrlong{spmd}} parallel model. \\
